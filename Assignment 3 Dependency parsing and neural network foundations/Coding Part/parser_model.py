...
class ParserModel(nn.Module):
    ...
    def forward(self, t):
        ...
        hidden_units = self.embed_to_hidden(embeddings)
        hidden_units = F.relu(hidden_units)
        hidden_units = self.dropout(hidden_units)
        logits = self.hidden_to_logits(hidden_units)
        ### END YOUR CODE
        return logits
